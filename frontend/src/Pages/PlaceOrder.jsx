  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t '>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          < input required className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Zip Code' name='zipcode' onChange={onChangeHandler} value={formData.zipcode} />
        ...
        < input required className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Phone Number' name='phone' onChange={onChangeHandler} value={formData.phone} />
      </div>
      {/* -------------------rightside----------------- */}
      <div className='mt-8'>
